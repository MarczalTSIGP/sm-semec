...
<div class="card mb-2" id="accordion">
    ...
    <div id="edict{{$year}}" class="collapse" aria-labelledby="edict" data-parent="#accordion">
        ...
        <div class="card-header collapse-edicts d-flex ml-2" id="edict">
            <button class="btn btn-link collapsed" dusk="btnShowEdict-{{$edict->id}}" data-toggle="collapse" data-target="#edict{{$edict->id}}" aria-expanded="false" aria-controls="edict">
                {{$edict->title}}
            </button>
